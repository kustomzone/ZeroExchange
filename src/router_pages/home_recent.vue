<template>
	<div id="homeRecent" class="container">
		<div class="row">
	        <div class="col s12 m7 l9">
	        	<component :is="home_navbar" active="recent" :user-info="userInfo"></component>

                <component :is="question_list_item" v-for="question in questions" :key="question.question_id" :user-info="userInfo" :merger-zites="mergerZites" :question="question" :show-name="true" :current-topic-address="topicAddress" :show-topic-name="true"></component>
	        </div>
