	...
	<div id="topicSearch" class="container">
		<div class="row">
	        <div class="col s12 m7 l9">
		        ...
		        <component :is="question_list_item" v-for="question in getSearchResults" :merger-zites="mergerZites" :user-info="userInfo" :question="question" :show-name="true" :current-topic-address="topicAddress"></component>
	        </div>
